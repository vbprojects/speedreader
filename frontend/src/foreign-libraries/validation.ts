...
export function validateForeignItem(item: ForeignItem, libraryId: string): ForeignItem {
  if (!item || item.ref?.libraryId !== libraryId) invalid("Foreign item belongs to the wrong plugin");
